...
public class HospitalAdmission extends AbstractPcrCsvWriter {
 
 
 
  public HospitalAdmission(String fileName, CSVFormat csvFormat, String dateFormat, String timeFormat) throws Exception {

...
public class AllergyIntolerance extends AbstractPcrCsvWriter {
    ...
    public void writeUpsert(long id,
                            ...
                            Integer substanceConceptId,
                            Integer manifestationConceptId,
        ...
        super.printRecord(OutputContainer.UPSERT,
                ...
                convertInt(substanceConceptId),
                convertInt(manifestationConceptId),
...
//            substance_concept_id int COMMENT 'concept representing the substance (as opposed to the allergy code, which is on the observation table)',
//            manifestation_concept_id int COMMENT 'concept stating how this allergy manifests itself (e.g. rash, anaphylactic shock)',

...
//            drug_concept_id int NOT NULL COMMENT 'refers to information model, giving the clinical concept of the event',
...
//            type_concept_id int NOT NULL COMMENT 'refers to information model to give the prescription type (e.g. Acute, Repeat, RepeatDispensing)',
...
//            end_reason_concept_id int COMMENT 'reason for ending this medication',

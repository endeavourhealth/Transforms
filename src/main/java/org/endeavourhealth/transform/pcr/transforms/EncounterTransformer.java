...
public class EncounterTransformer extends AbstractTransformer {
    ...
    private Long findRecordingPractitionerId(Encounter fhir, PcrTransformParams params) throws Exception {
        if (!fhir.hasExtension()) {
            return null;
        }
    ...
    private Long findLocationId(Encounter fhir, PcrTransformParams params) throws Exception {
    ...
    /*private void transformEncounterRaw(Long enterpriseId, Resource resource, PcrTransformParams params,
                                       long id, long organisationId, long patientId, long personId, long practitionerId,
                                       long episodeOfCareId, Date clinicalEffectiveDate, Integer datePrecisionId, Long appointmentId,
    ...
    private static String findEncounterTypeTerm(Encounter fhir, PcrTransformParams params) {
    ...
    /*private EncounterCode mapEncounterCode(Encounter fhir, PcrTransformParams params) throws Exception {

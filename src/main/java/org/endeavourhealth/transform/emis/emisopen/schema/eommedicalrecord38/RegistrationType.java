    ...
    extends IdentType
{
    ...
    public static class CustomRegistrationFields {
        ...
        protected List<CustomRegistrationEntry> customRegistrationEntry;
         ...
         *
         */
        public List<CustomRegistrationEntry> getCustomRegistrationEntry() {
            if (customRegistrationEntry == null) {
                customRegistrationEntry = new ArrayList<CustomRegistrationEntry>();
            }

...
public class ElementListType {
    ...
    protected List<ConsultationElement> consultationElement;
     ...
     *
     */
    public List<ConsultationElement> getConsultationElement() {
        if (consultationElement == null) {
            consultationElement = new ArrayList<ConsultationElement>();
        }

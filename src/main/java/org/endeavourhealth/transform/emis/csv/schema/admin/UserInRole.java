...
public class UserInRole extends AbstractCsvParser {
    ...
    public UserInRole(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath, boolean openParser) throws Exception {

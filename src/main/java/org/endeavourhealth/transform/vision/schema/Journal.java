...
public class Journal extends AbstractCsvParser {
    ...
    public CsvCell getObservationID() {return super.getCell("ID"); }
    ...
    public CsvCell getEffectiveDateTime() throws TransformException { return super.getCell("DATE"); }
    public CsvCell getEnteredDateTime() throws TransformException { return super.getCell("RECORDED_DATE"); }
    public CsvCell getReadCode() { return super.getCell("CODE"); }
    ...
    public CsvCell getProblemEpisodicity() { return super.getCell("EPISODE"); }   //if CODE = Diagnosis or Problem
    public CsvCell getDrugPrescriptionType() { return super.getCell("EPISODE"); } //if CODE = Prescribeable item
    public CsvCell getDrugDMDCode() { return super.getCell("DMD_CODE"); }
    public CsvCell getDrugPrep() { return super.getCell("DRUG_PACKSIZE"); }   //this is ml, tablet, capsule in test data
    public CsvCell getAssociatedText() { return super.getCell("TEXT"); }     //dosage for medication
    public CsvCell getRubric() { return super.getCell("RUBRIC"); }
    public CsvCell getValue1Name() { return super.getCell("VALUE1_NAME"); }
    public CsvCell getValue1AsText() { return super.getCell("VALUE1"); }
    public CsvCell getValue1() { return super.getCell("VALUE1"); }   //if drug, then amount, else numeric value for investigation, value, result
    public CsvCell getValue1NumericUnit() { return super.getCell("VALUE1_UNITS"); }
    public CsvCell getValue2() { return super.getCell("VALUE2"); }   //second value for BP or special case
    public CsvCell getValue2NumericUnit() { return super.getCell("VALUE2_UNITS"); }
    public CsvCell getImmsStatus() { return super.getCell("IMMS_STATUS"); }
    public CsvCell getImmsCompound() { return super.getCell("IMMS_COMPOUND"); }
    public CsvCell getImmsSource() { return super.getCell("IMMS_SOURCE"); }
    public CsvCell getImmsBatch() { return super.getCell("IMMS_BATCH"); }
    public CsvCell getImmsReason() { return super.getCell("IMMS_REASON"); }
    public CsvCell getImmsMethod() { return super.getCell("IMMS_METHOD"); }
    public CsvCell getImmsSite() { return super.getCell("IMMS_SITE"); }
    public CsvCell getEndDate() throws TransformException { return super.getCell("END_DATE"); }   //Episode end date (F or N) or drug end date (A or I)
    public CsvCell getAllergyCertainty() { return super.getCell("CERTAINTY"); }
    public CsvCell getAllergySeverity() { return super.getCell("SEVERITY"); }
    public CsvCell getLinks() { return super.getCell("LINKS"); }
    public CsvCell getAction() { return super.getCell("ACTION"); }
    public CsvCell getSubset() { return super.getCell("SUBSET"); }
    public CsvCell getObservationEntity() { return super.getCell("ENTITY"); }
    public CsvCell getDocumentID() { return super.getCell("DOCUMENT_ID"); }

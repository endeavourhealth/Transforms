...
public class Spells extends AbstractCsvParser {
    ...
    public CsvCell getAdmissionDttm() {
        return super.getCell("ADMISSION_DTTM");
    }

    public CsvCell getAdmissionConsultant() {
        return super.getCell("ADMISSION_CONSULTANT");
    }

    public CsvCell getAdmissionConsultantCode() {
        return super.getCell("ADMISSION_CONSULTANT_CODE");
    }

    public CsvCell getAdmissionConsultantMainSpecialtyCode() {
        return super.getCell("ADMISSION_CONSULTANT_MAIN_SPECIALTY_CODE");
    }
    ...
    public CsvCell getAdmissionSpecialty() {
        return super.getCell("ADMISSION_SPECIALTY");
    }

    public CsvCell getAdmissionSpecialtyCode() {
        return super.getCell("ADMISSION_SPECIALTY_CODE");
    }

    public CsvCell getAdmissionWard() {
        return super.getCell("ADMISSION_WARD");
    }

    public CsvCell getAdmissionWardCode() {
        return super.getCell("ADMISSION_WARD_CODE");
    }

    public CsvCell getRegularDayNight() {
        return super.getCell("REGULAR_DAY_NIGHT");
    }

    public CsvCell getRegularDayNightCode() {
        return super.getCell("REGULAR_DAY_NIGHT_CODE");
    }
    ...
    public CsvCell getMedicalDischargeDttm() {
        return super.getCell("MEDICAL_DISCHARGE_DTTM");
    }

    public CsvCell getVteAssessment() {
        return super.getCell("VTE_ASSESSMENT");
    }

    public CsvCell getDischargeDttm() {
        return super.getCell("DISCHARGE_DTTM");
    }
    ...
    public CsvCell getDischargeDestinationCode() {
        return super.getCell("DISCHARGE_DESTINATION_CODE");
    }

    public CsvCell getDischargeConsultant() {
        return super.getCell("DISCHARGE_CONSULTANT");
    }

    public CsvCell getDischargeConsultantCode() {
        return super.getCell("DISCHARGE_CONSULTANT_CODE");
    }

    public CsvCell getDischargeConsultantMainSpecialty() {
        return super.getCell("DISCHARGE_CONSULTANT_MAIN_SPECIALTY");
    }

    public CsvCell getDischargeConsultantMainSpecialtyCode() {
        return super.getCell("DISCHARGE_CONSULTANT_MAIN_SPECIALTY_CODE");
    }

    public CsvCell getDischargeHospitalName() {
        return super.getCell("DISCHARGE_HOSPITAL_NAME");
    }

    public CsvCell getDischargeHospitalCode() {
        return super.getCell("DISCHARGE_HOSPITAL_CODE");
    }

    public CsvCell getDischargeSpecialty() {
        return super.getCell("DISCHARGE_SPECIALTY");
    }

    public CsvCell getDischargeSpecialtyCode() {
        return super.getCell("DISCHARGE_SPECIALTY_CODE");
    }

    public CsvCell getDischargeWard() {
        return super.getCell("DISCHARGE_WARD");
    }

    public CsvCell getDischargeWardCode() {
        return super.getCell("DISCHARGE_WARD_CODE");
    }

    public CsvCell getTransferredToDischargeLoungeDttm() {
        return super.getCell("TRANSFERRED_TO_DISCHARGE_LOUNGE_DTTM");
    }

    public CsvCell getDischargeLocation() {
        return super.getCell("DISCHARGE_LOCATION");
    }

    public CsvCell getDischargeLocationCode() {
        return super.getCell("DISCHARGE_LOCATION_CODE");
    }

    public CsvCell getPrimaryDiagnosis() {
        return super.getCell("PRIMARY_DIAGNOSIS");
    }
    ...
    public CsvCell getReferringConsultant() {
        return super.getCell("REFERRING_CONSULTANT");
    }

    public CsvCell getSpellRegisteredGpCode() {
        return super.getCell("SPELL_REGISTERED_GP_CODE");
    }

    public CsvCell getSpellRegisteredGpPracticeCode() {
        return super.getCell("SPELL_REGISTERED_GP_PRACTICE_CODE");
    }

    public CsvCell getSpellCcg() {
        return super.getCell("SPELL_CCG");
    }
    ...
    public CsvCell getReadmissionExternalId() {
        return super.getCell("READMISSION_IPSP_EXT_ID");
    }

    public CsvCell getWlentryExternalId() {
        return super.getCell("WLENTRY_EXTERNAL_ID");
    }

...
public class ProcedureDelete extends AbstractCsvParser {

    public ProcedureDelete(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {

...
public class PersonAliasDelete extends AbstractCsvParser {

    public PersonAliasDelete(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {

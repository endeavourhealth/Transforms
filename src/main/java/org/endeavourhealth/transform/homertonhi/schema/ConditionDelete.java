...
public class ConditionDelete extends AbstractCsvParser {

    public ConditionDelete(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {

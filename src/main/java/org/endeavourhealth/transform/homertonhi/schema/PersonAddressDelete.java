...
public class PersonAddressDelete extends AbstractCsvParser {

    public PersonAddressDelete(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {

...
*/
     ...
     */
    public static ResourceId resolveEncounterResource(String primaryOrgHL7OrgOID, SusEmergency parser, FhirResourceFiler fhirResourceFiler, ResourceId patientResourceId) throws Exception {
    ...
    public static ResourceId resolvePatientResource(String primaryOrgHL7OrgOID, SusEmergency parser, FhirResourceFiler fhirResourceFiler) throws Exception {
     ...
     */
    public static Patient createPatientResource(SusEmergency parser, String primaryOrgHL7OrgOID) {

...
public class SusEmergencyCareDataSetTailPreTransformer {

    /**
     * simply caches the contents of a tails file into a hashmap
     */
    public static void transform(SusEmergencyCareDataSetTail parser, Map<String, SusTailCacheEntry> tailsCache) throws Exception {
    ...
    private static void processRecord(SusEmergencyCareDataSetTail parser, Map<String, SusTailCacheEntry> tailsCache) {

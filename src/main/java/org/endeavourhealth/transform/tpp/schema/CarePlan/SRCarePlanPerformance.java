...
public class SRCarePlanPerformance extends AbstractCsvParser {
 ...
 public CsvCell getContactMethodWihPatient() { return super.getCell("ContactMethodWihPatient");};
 public CsvCell getContactWith() { return super.getCell("ContactWith");};
 public CsvCell getLengthOfContactWithPatient() { return super.getCell("LengthOfContactWithPatient");};
 public CsvCell getDistanceTravelled() { return super.getCell("DistanceTravelled");};
 ...
 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRCarePlanPerformance Entry file ";}

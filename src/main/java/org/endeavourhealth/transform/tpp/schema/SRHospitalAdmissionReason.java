...
public class SRHospitalAdmissionReason extends AbstractCsvParser {
 ...
 public CsvCell getAdmissionReason() { return super.getCell("AdmissionReason");};
 public CsvCell getDateDeleted() { return super.getCell("DateDeleted");};
 public CsvCell getDateModified() { return super.getCell("DateModified");};
 public CsvCell getRemovedData() { return super.getCell("RemovedData");};


 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRHospitalAdmissionReason Entry file ";}

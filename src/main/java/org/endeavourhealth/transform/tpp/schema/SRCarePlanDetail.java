...
public class SRCarePlanDetail extends AbstractCsvParser {
 ...
 public CsvCell getPlanType() { return super.getCell("PlanType");};
 public CsvCell getPatientAgreement() { return super.getCell("PatientAgreement");};
 public CsvCell getAfterCare117() { return super.getCell("AfterCare117");};


 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRCarePlanDetail Entry file ";}

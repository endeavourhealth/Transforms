...
public class SRHospitalAlertIndicator extends AbstractCsvParser {
 ...
 public CsvCell getAlertType() { return super.getCell("AlertType");};
 public CsvCell getAlertCode() { return super.getCell("AlertCode");};
 public CsvCell getAlertTextual() { return super.getCell("AlertTextual");};
 public CsvCell getHiddenWardView() { return super.getCell("HiddenWardView");};
 public CsvCell getLatexAllergy() { return super.getCell("LatexAllergy");};
 public CsvCell getDNAR() { return super.getCell("DNAR");};
 ...
 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRHospitalAlertIndicator Entry file ";}

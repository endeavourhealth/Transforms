...
public class SRHospitalAdmissionAndDischarge extends AbstractCsvParser {
 ...
 public CsvCell getDateAdmissionCreated() { return super.getCell("DateAdmissionCreated");};
 ...
 public CsvCell getAdmissionConfirmed() { return super.getCell("AdmissionConfirmed");};
 public CsvCell getAdmissionLetterPrinted() { return super.getCell("AdmissionLetterPrinted");};
 public CsvCell getDateAdmitted() { return super.getCell("DateAdmitted");};
 public CsvCell getIDProfileAdmittedBy() { return super.getCell("IDProfileAdmittedBy");};
 public CsvCell getAdmissionNotes() { return super.getCell("AdmissionNotes");};
 public CsvCell getDateCancelled() { return super.getCell("DateCancelled");};
 public CsvCell getIDProfileCancelledBy() { return super.getCell("IDProfileCancelledBy");};
 public CsvCell getCancelledReason() { return super.getCell("CancelledReason");};
 public CsvCell getTreatmentFunction() { return super.getCell("TreatmentFunction");};
 public CsvCell getSourceOfAdmission() { return super.getCell("SourceOfAdmission");};
 ...
 public CsvCell getReAdmission() { return super.getCell("ReAdmission");};
 public CsvCell getDateDischarged() { return super.getCell("DateDischarged");};
 public CsvCell getIDProfileResponsibleClinician() { return super.getCell("IDProfileResponsibleClinician");};
 ...
 public CsvCell getTreatmentStatus() { return super.getCell("TreatmentStatus");};
 public CsvCell getMethodOfDischarge() { return super.getCell("MethodOfDischarge");};
 public CsvCell getDestinationAfterDischarge() { return super.getCell("DestinationAfterDischarge");};
 ...
 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRHospitalAdmissionAndDischarge Entry file ";}

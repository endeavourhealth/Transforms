...
public class SRCarePlanItem extends AbstractCsvParser {
 ...
 public CsvCell getInstruction() { return super.getCell("Instruction");};
 public CsvCell getDateRemoved() { return super.getCell("DateRemoved");};
 public CsvCell getIDAddedCreatedBy() { return super.getCell("IDAddedCreatedBy");};
 ...
 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRCarePlanItem Entry file ";}

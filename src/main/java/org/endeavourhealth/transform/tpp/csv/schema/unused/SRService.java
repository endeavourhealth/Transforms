...
public class SRService extends AbstractCsvParser {
    ...
    public CsvCell getServiceName() {
        return super.getCell("ServiceName");
    }
    ...
    public CsvCell getServiceCategory() {
        return super.getCell("ServiceCategory");
    }

    public CsvCell getIDPatientRelationshipCarer() {
        return super.getCell("IDPatientRelationshipCarer");
    }
    ...
    public CsvCell getIndicativeServiceCost() {
        return super.getCell("IndicativeServiceCost");
    }

    public CsvCell getTrustFunded() {
        return super.getCell("TrustFunded");
    }

...
public class SRBedPatient extends AbstractCsvParser {
    ...
    public CsvCell getBedName() {
        return super.getCell("BedName");
    }

    public CsvCell getIsLodger() {
        return super.getCell("IsLodger");
    }

    public CsvCell getDateBedDetailsStart() {
        return super.getCell("DateBedDetailsStart");
    }

    public CsvCell getDateBedDetailsEnd() {
        return super.getCell("DateBedDetailsEnd");
    }
    ...
    protected String getFileTypeDescription() {
        return "TPP SRBedPatient Entry file ";
    }

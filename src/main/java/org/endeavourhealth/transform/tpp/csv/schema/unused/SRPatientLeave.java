...
public class SRPatientLeave extends AbstractCsvParser {
    ...
    public CsvCell getLeaveType() {
        return super.getCell("LeaveType");
    }

    public CsvCell getDateExpectedStart() {
        return super.getCell("DateExpectedStart");
    }
    ...
    public CsvCell getDateActualStart() {
        return super.getCell("DateActualStart");
    }

    public CsvCell getDateActualEnd() {
        return super.getCell("DateActualEnd");
    }
    ...
    public CsvCell getSCTConsideredDate() {
        return super.getCell("SCTConsideredDate");
    }

    public CsvCell getLeaveApproved() {
        return super.getCell("LeaveApproved");
    }
    ...
    public CsvCell getFreeBed() {
        return super.getCell("FreeBed");
    }

...
public class SRWaitingList extends AbstractCsvParser {
    ...
    public CsvCell getDateAppointmentStart() {
        return super.getCell("DateAppointmentStart");
    }

    public CsvCell getDateAppointmentEnd() {
        return super.getCell("DateAppointmentEnd");
    }
    ...
    public CsvCell getRestrictedToCaseload() {
        return super.getCell("RestrictedToCaseload");
    }

    public CsvCell getTargetMaximumWait() {
        return super.getCell("TargetMaximumWait");
    }
    ...
    public CsvCell getDateDue() {
        return super.getCell("DateDue");
    }

    public CsvCell getNotes() {
        return super.getCell("Notes");
    }

    public CsvCell getDateWaitCompleted() {
        return super.getCell("DateWaitCompleted");
    }

    public CsvCell getDateDeletedFromWaitingList() {
        return super.getCell("DateDeletedFromWaitingList");
    }

...
public class SRReferralContactEvent extends AbstractCsvParser {
    ...
    public CsvCell getLength() {
        return super.getCell("Length");
    }
    ...
    public CsvCell getSubCategory() {
        return super.getCell("SubCategory");
    }

    public CsvCell getClinicallyRelevant() {
        return super.getCell("ClinicallyRelevant");
    }

    public CsvCell getTeam() {
        return super.getCell("Team");
    }
    ...
    public CsvCell getDateInitialContact() {
        return super.getCell("DateInitialContact");
    }

    public CsvCell getIDRegisteredPracticeAtTimeOfEvent() {
        return super.getCell("IDRegisteredPracticeAtTimeOfEvent");
    }

    public CsvCell getIDRegisteredGpAtTimeOfEvent() {
        return super.getCell("IDRegisteredGpAtTimeOfEvent");
    }

...
public class SROohAssessment extends AbstractCsvParser {
    ...
    public CsvCell getDateAssessment() {
        return super.getCell("DateAssessment");
    }
    ...
    public CsvCell getPriorityType() {
        return super.getCell("PriorityType");
    }
    ...
    public CsvCell getIDCase() {
        return super.getCell("IDCase");
    }

...
public class SRRiskReview extends AbstractCsvParser {
    ...
    public CsvCell getRiskCategory() {
        return super.getCell("RiskCategory");
    }

    public CsvCell getRiskSubCategory() {
        return super.getCell("RiskSubCategory");
    }

    public CsvCell getRiskRating() {
        return super.getCell("RiskRating");
    }

    public CsvCell getRiskReviewDate() {
        return super.getCell("RiskReviewDate");
    }

    public CsvCell getRiskReviewDueDate() {
        return super.getCell("RiskReviewDueDate");
    }

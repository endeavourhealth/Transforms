...
public class SRTTOMedication extends AbstractCsvParser {
    ...
    public CsvCell getStandardOrInstalment() {
        return super.getCell("StandardOrInstalment");
    }

    public CsvCell getStandardIssueDose() {
        return super.getCell("StandardIssueDose");
    }

    public CsvCell getStandardIssueQuantity() {
        return super.getCell("StandardIssueQuantity");
    }

    public CsvCell getInstalmentDailyDose() {
        return super.getCell("InstalmentDailyDose");
    }

    public CsvCell getInstalmentSupervisedDose() {
        return super.getCell("InstalmentSupervisedDose");
    }

    public CsvCell getContinuation() {
        return super.getCell("Continuation");
    }

    public CsvCell getDateFirstAdmin() {
        return super.getCell("DateFirstAdmin");
    }

    public CsvCell getDateSupplyUntil() {
        return super.getCell("DateSupplyUntil");
    }
    ...
    public CsvCell getIDMedicationEndedBy() {
        return super.getCell("IDMedicationEndedBy");
    }

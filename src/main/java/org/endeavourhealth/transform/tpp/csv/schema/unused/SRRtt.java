...
public class SRRtt extends AbstractCsvParser {
    ...
    public CsvCell getDateClockStop() {
        return super.getCell("DateClockStop");
    }
    ...
    public CsvCell getBreachReason() {
        return super.getCell("BreachReason");
    }

    public CsvCell getErrorInClockCausedBreach() {
        return super.getCell("ErrorInClockCausedBreach");
    }

    public CsvCell getLedBy() {
        return super.getCell("LedBy");
    }

    public CsvCell getWaitType() {
        return super.getCell("WaitType");
    }

    public CsvCell getIDPatientPathWay() {
        return super.getCell("IDPatientPathWay");
    }

    public CsvCell getCancerSite() {
        return super.getCell("CancerSite");
    }

    public CsvCell getRequestRaisedReason() {
        return super.getCell("RequestRaisedReason");
    }

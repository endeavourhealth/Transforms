...
public class SRCarePlan extends AbstractCsvParser {
    ...
    public CsvCell getFrequencyOfCareOccurrence() {
        return super.getCell("FrequencyOfCareOccurrence");
    }

    public CsvCell getFrequencyTypeOfCareOccurrence() {
        return super.getCell("FrequencyTypeOfCareOccurrence");
    }

    public CsvCell getUsualCarer() {
        return super.getCell("UsualCarer");
    }

    public CsvCell getIDProfileUsualCarer() {
        return super.getCell("IDProfileUsualCarer");
    }

    public CsvCell getEstimatedDuration() {
        return super.getCell("EstimatedDuration");
    }

    public CsvCell getPreferredTime() {
        return super.getCell("PreferredTime");
    }
    ...
    protected String getFileTypeDescription() {
        return "TPP SRCarePlan Entry file ";
    }

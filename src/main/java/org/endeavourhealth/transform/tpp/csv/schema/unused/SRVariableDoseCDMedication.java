...
public class SRVariableDoseCDMedication extends AbstractCsvParser {
 ...
 public CsvCell getMedicationCourseLength() { return super.getCell("MedicationCourseLength");}
 ...
 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRVariableDoseCDMedication Entry file ";}

...
public class SRSectionedBy extends AbstractCsvParser {
    ...
    public CsvCell getSourceTableForSectionedBy() {
        return super.getCell("SourceTableForSectionedBy");
    }

    public CsvCell getIDForSectionedBy() {
        return super.getCell("IDForSectionedBy");
    }

    public CsvCell getRole() {
        return super.getCell("Role");
    }

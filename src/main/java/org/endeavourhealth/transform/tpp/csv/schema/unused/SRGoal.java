...
public class SRGoal extends AbstractCsvParser {
    ...
    public CsvCell getGoalCategory() {
        return super.getCell("GoalCategory");
    }

    public CsvCell getGoalType() {
        return super.getCell("GoalType");
    }

    public CsvCell getGoalOutcome() {
        return super.getCell("GoalOutcome");
    }

    public CsvCell getGoalImportance() {
        return super.getCell("GoalImportance");
    }

    public CsvCell getDateGoalTarget() {
        return super.getCell("DateGoalTarget");
    }

    public CsvCell getActionPlanCategory() {
        return super.getCell("ActionPlanCategory");
    }

    public CsvCell getActionPlanPatientConfidence() {
        return super.getCell("ActionPlanPatientConfidence");
    }

    public CsvCell getActionPlanOutcome() {
        return super.getCell("ActionPlanOutcome");
    }

    public CsvCell getDateEndedActionPlan() {
        return super.getCell("DateEndedActionPlan");
    }

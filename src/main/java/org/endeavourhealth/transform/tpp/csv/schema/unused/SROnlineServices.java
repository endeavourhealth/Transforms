...
public class SROnlineServices extends AbstractCsvParser {
    ...
    public CsvCell getViewRecord() {
        return super.getCell("ViewRecord");
    }

    public CsvCell getAppointments() {
        return super.getCell("Appointments");
    }

    public CsvCell getPrescriptions() {
        return super.getCell("Prescriptions");
    }

    public CsvCell getQuestionnaires() {
        return super.getCell("Questionnaires");
    }

    public CsvCell getSummaryCareRecord() {
        return super.getCell("SummaryCareRecord");
    }
    ...
    public CsvCell getDetailedCodedRecord() {
        return super.getCell("DetailedCodedRecord");
    }

    public CsvCell getIDOnlineUser() {
        return super.getCell("IDOnlineUser");
    }

...
public class SROohPathways extends AbstractCsvParser {
    ...
    public CsvCell getDateTriageStart() {
        return super.getCell("DateTriageStart");
    }

    public CsvCell getDateTriageEnd() {
        return super.getCell("DateTriageEnd");
    }

    public CsvCell getFinalDispositionCode() {
        return super.getCell("FinalDispositionCode");
    }

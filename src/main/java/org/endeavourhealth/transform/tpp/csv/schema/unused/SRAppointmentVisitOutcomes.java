...
public class SRAppointmentVisitOutcomes extends AbstractCsvParser {
    ...
    public CsvCell getDateRecorded() {
        return super.getCell("DateRecorded");
    }

    public CsvCell getIDProfileResponsibleProfessional() {
        return super.getCell("IDProfileResponsibleProfessional");
    }

    public CsvCell getConsultantSpecialtyMappingCode() {
        return super.getCell("ConsultantSpecialtyMappingCode");
    }

    public CsvCell getTreatmentCodeMappingCode() {
        return super.getCell("TreatmentCodeMappingCode");
    }
    ...
    public CsvCell getOutcomeOfAttendanceMappingCode() {
        return super.getCell("OutcomeOfAttendanceMappingCode");
    }

    public CsvCell getOperationStatus() {
        return super.getCell("OperationStatus");
    }
    ...
    public CsvCell getOutcomeOfAttendance() {
        return super.getCell("OutcomeOfAttendance");
    }

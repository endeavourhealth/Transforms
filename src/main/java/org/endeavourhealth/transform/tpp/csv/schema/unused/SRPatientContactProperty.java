...
public class SRPatientContactProperty extends AbstractCsvParser {
    ...
    public CsvCell getPatientContactType() {
        return super.getCell("PatientContactType");
    }

    public CsvCell getPatientContactId() {
        return super.getCell("PatientContactId");
    }

    public CsvCell getPropertyType() {
        return super.getCell("PropertyType");
    }

    public CsvCell getProperty() {
        return super.getCell("Property");
    }

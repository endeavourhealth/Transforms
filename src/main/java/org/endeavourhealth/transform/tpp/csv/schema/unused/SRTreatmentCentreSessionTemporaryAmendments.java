...
public class SRTreatmentCentreSessionTemporaryAmendments extends AbstractCsvParser {
    ...
    public CsvCell getDateTemporaryAmendment() {
        return super.getCell("DateTemporaryAmendment");
    }

    public CsvCell getDateTemporaryAmendmentDeleted() {
        return super.getCell("DateTemporaryAmendmentDeleted");
    }

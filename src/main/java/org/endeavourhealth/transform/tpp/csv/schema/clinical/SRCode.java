...
public class SRCode extends AbstractCsvParser {
 ...
 public CsvCell getNumericValue() { return super.getCell("NumericValue");};
 public CsvCell getNumericUnit() { return super.getCell("NumericUnit");};
 public CsvCell getEpisodeType() { return super.getCell("EpisodeType");};
 public CsvCell getIDTemplate() { return super.getCell("IDTemplate");};
 ...
 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP Read Codes Entry file ";}

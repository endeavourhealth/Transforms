...
public class SROnAdmissionMedication extends AbstractCsvParser {
    ...
    public CsvCell getDoseFrequency() {
        return super.getCell("DoseFrequency");
    }
    ...
    public CsvCell getMedicationInformationSource() {
        return super.getCell("MedicationInformationSource");
    }

    public CsvCell getIDProfileMedicationInformationSource() {
        return super.getCell("IDProfileMedicationInformationSource");
    }
    ...
    public CsvCell getReprescribed() {
        return super.getCell("Represcribed");
    }

    public CsvCell getIDProfileReprescribedBy() {
        return super.getCell("IDProfileReprescribedBy");
    }

    public CsvCell getHistoryChecked() {
        return super.getCell("HistoryChecked");
    }

    public CsvCell getIDHistoryCheckedBy() {
        return super.getCell("IDHistoryCheckedBy");
    }

    public CsvCell getIDProfileHistoryCheckedBy() {
        return super.getCell("IDProfileHistoryCheckedBy");
    }

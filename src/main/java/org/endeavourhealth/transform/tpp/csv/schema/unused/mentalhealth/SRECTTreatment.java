...
public class SRECTTreatment extends AbstractCsvParser {
    ...
    public CsvCell getTreatmentDate() {
        return super.getCell("TreatmentDate");
    }

    public CsvCell getRecoveryPerson() {
        return super.getCell("RecoveryPerson");
    }

    public CsvCell getOdpPerson() {
        return super.getCell("OdpPerson");
    }

    public CsvCell getAnaesthetist() {
        return super.getCell("Anaesthetist");
    }

    public CsvCell getTreatingDoctor() {
        return super.getCell("TreatingDoctor");
    }
    ...
    public CsvCell getIDECTCourse() {
        return super.getCell("IDECTCourse");
    }

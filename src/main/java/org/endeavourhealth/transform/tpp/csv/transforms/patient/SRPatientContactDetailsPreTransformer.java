...
public class SRPatientContactDetailsPreTransformer {
        ...
        try {
            ...
            if (parser != null) {
                while (parser.nextRecord()) {
                    ...
                    try {
                        processRecord((SRPatientContactDetails) parser, fhirResourceFiler, csvHelper);
                    } catch (Exception ex) {
    ...
    private static void processRecord(SRPatientContactDetails parser, FhirResourceFiler fhirResourceFiler, TppCsvHelper csvHelper) throws Exception {

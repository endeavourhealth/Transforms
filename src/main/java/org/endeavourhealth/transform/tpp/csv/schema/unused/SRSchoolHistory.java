...
public class SRSchoolHistory extends AbstractCsvParser {
    ...
    public CsvCell getDateLeft() {
        return super.getCell("DateLeft");
    }

    public CsvCell getIDOrganisationSchool() {
        return super.getCell("IDOrganisationSchool");
    }

    public CsvCell getSchool() {
        return super.getCell("School");
    }

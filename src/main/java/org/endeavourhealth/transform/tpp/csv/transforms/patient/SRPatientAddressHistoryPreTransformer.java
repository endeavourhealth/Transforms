...
public class SRPatientAddressHistoryPreTransformer {
        ...
        try {
            ...
            if (parser != null) {
                while (parser.nextRecord()) {
                    ...
                    try {
                        processRecord((SRPatientAddressHistory) parser, fhirResourceFiler, csvHelper, threadPool);
                    } catch (Exception ex) {
    ...
    private static void processRecord(SRPatientAddressHistory parser, FhirResourceFiler fhirResourceFiler, TppCsvHelper csvHelper, ThreadPool threadPool) throws Exception {

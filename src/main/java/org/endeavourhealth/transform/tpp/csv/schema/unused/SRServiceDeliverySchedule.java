...
public class SRServiceDeliverySchedule extends AbstractCsvParser {

    private static final Logger LOG = LoggerFactory.getLogger(SRServiceDeliverySchedule.class);

    public SRServiceDeliverySchedule(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {
    ...
    public CsvCell getIDService() {
        return super.getCell("IDService");
    }
    ...
    public CsvCell getIsSuspension() {
        return super.getCell("IsSuspension");
    }

    public CsvCell getCost() {
        return super.getCell("Cost");
    }

    public CsvCell getHours() {
        return super.getCell("Hours");
    }

    public CsvCell getWeeks() {
        return super.getCell("Weeks");
    }

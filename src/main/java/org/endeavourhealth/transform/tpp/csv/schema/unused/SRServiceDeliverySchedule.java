...
public class SRServiceDeliverySchedule extends AbstractCsvParser {
 ...
 public CsvCell getIsSuspension() { return super.getCell("IsSuspension");}
 public CsvCell getCost() { return super.getCell("Cost");}
 public CsvCell getHours() { return super.getCell("Hours");}
 public CsvCell getWeeks() { return super.getCell("Weeks");}

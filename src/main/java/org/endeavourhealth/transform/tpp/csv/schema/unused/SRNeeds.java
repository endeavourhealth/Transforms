...
public class SRNeeds extends AbstractCsvParser {

    private static final Logger LOG = LoggerFactory.getLogger(SRNeeds.class);

    public SRNeeds(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {
    ...
    public CsvCell getNeedName() {
        return super.getCell("NeedName");
    }

    public CsvCell getNeedPriority() {
        return super.getCell("NeedPriority");
    }
    ...
    public CsvCell getNeedMet() {
        return super.getCell("NeedMet");
    }

    public CsvCell getReasonNeedNotMet() {
        return super.getCell("ReasonNeedNotMet");
    }

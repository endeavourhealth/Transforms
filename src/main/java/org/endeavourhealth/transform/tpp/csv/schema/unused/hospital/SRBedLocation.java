...
public class SRBedLocation extends AbstractCsvParser {
    ...
    public CsvCell getDateBedLocationStart() {
        return super.getCell("DateBedLocationStart");
    }

    public CsvCell getDateBedLocationEnd() {
        return super.getCell("DateBedLocationEnd");
    }

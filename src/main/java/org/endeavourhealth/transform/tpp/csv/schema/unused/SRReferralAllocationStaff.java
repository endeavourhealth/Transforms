...
public class SRReferralAllocationStaff extends AbstractCsvParser {
    ...
    public CsvCell getIDReferralAllocation() {
        return super.getCell("IDReferralAllocation");
    }
    ...
    public CsvCell getIDProfileStaffMember() {
        return super.getCell("IDProfileStaffMember");
    }

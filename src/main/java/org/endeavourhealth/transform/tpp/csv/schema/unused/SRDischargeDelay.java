...
public class SRDischargeDelay extends AbstractCsvParser {
    ...
    public CsvCell getMedicallyReadyForDischarge() {
        return super.getCell("MedicallyReadyForDischarge");
    }

    public CsvCell getDateMedicallyReadyForDischarge() {
        return super.getCell("DateMedicallyReadyForDischarge");
    }

    public CsvCell getReasonForDelay() {
        return super.getCell("ReasonForDelay");
    }

    public CsvCell getResponsibility() {
        return super.getCell("Responsibility");
    }

    public CsvCell getDateDelayStart() {
        return super.getCell("DateDelayStart");
    }

    public CsvCell getDateDelayEnd() {
        return super.getCell("DateDelayEnd");
    }

    public CsvCell getIDAdmission() {
        return super.getCell("IDAdmission");
    }

...
public class SRHospitalWaitingListSuspension extends AbstractCsvParser {
    ...
    public CsvCell getSuspensionReason() {
        return super.getCell("SuspensionReason");
    }
    ...
    public CsvCell getSuspensionType() {
        return super.getCell("SuspensionType");
    }
    ...
    public CsvCell getDateClinicalReview() {
        return super.getCell("DateClinicalReview");
    }

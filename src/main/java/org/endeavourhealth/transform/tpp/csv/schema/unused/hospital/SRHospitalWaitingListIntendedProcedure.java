...
public class SRHospitalWaitingListIntendedProcedure extends AbstractCsvParser {
    ...
    public CsvCell getProcedureTest() {
        return super.getCell("ProcedureTest");
    }

    public CsvCell getProcedureTestCode() {
        return super.getCell("ProcedureTestCode");
    }

    public CsvCell getSiteLaterality() {
        return super.getCell("SiteLaterality");
    }
    ...
    public CsvCell getPrimary() {
        return super.getCell("Primary");
    }

    public CsvCell getIsDeleted() {
        return super.getCell("IsDeleted");
    }

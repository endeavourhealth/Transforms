...
public class SRTeamMember extends AbstractCsvParser {
    ...
    public CsvCell getTeamStaff() {
        return super.getCell("TeamStaff");
    }
    ...
    public CsvCell getMemberCreated() {
        return super.getCell("MemberCreated");
    }

    public CsvCell getMemberDeleted() {
        return super.getCell("MemberDeleted");
    }

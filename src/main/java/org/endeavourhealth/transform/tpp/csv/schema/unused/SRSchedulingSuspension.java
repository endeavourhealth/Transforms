...
public class SRSchedulingSuspension extends AbstractCsvParser {

    private static final Logger LOG = LoggerFactory.getLogger(SRSchedulingSuspension.class);

    public SRSchedulingSuspension(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {
    ...
    public CsvCell getSuspendedIdefinitely() {
        return super.getCell("SuspendedIdefinitely");
    }
    ...
    public CsvCell getEverAmended() {
        return super.getCell("EverAmended");
    }

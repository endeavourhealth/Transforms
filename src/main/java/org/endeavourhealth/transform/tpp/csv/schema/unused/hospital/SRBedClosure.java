...
public class SRBedClosure extends AbstractCsvParser {
    ...
    public CsvCell getDateBedClosureStart() {
        return super.getCell("DateBedClosureStart");
    }

    public CsvCell getDateBedClosureEnd() {
        return super.getCell("DateBedClosureEnd");
    }

    public CsvCell getBedClosureReason() {
        return super.getCell("BedClosureReason");
    }

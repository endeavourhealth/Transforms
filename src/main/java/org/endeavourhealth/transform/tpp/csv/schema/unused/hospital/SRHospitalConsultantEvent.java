...
public class SRHospitalConsultantEvent extends AbstractCsvParser {
    ...
    public CsvCell getConsultantSpecialty() {
        return super.getCell("ConsultantSpecialty");
    }
    ...
    public CsvCell getLegalClassification() {
        return super.getCell("LegalClassification");
    }

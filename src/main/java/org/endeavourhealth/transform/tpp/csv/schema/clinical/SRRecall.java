...
public class SRRecall extends AbstractCsvParser {
 ...
 private static final Logger LOG = LoggerFactory.getLogger(SRRecall.class);
    ...
    public CsvCell getDateRecall() { return super.getCell("DateRecall");};
    public CsvCell getRecallType() { return super.getCell("RecallType");};
    public CsvCell getRecallInitialStatus() { return super.getCell("RecallInitialStatus");};
    public CsvCell getRecallStatus() { return super.getCell("RecallStatus");};
    public CsvCell getRecallStatusDate() { return super.getCell("RecallStatusDate");};

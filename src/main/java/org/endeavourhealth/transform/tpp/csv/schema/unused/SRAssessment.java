...
public class SRAssessment extends AbstractCsvParser {
    ...
    public CsvCell getAssessmentFor() {
        return super.getCell("AssessmentFor");
    }

    public CsvCell getIDPatientRelationship() {
        return super.getCell("IDPatientRelationship");
    }

    public CsvCell getAssessmentType() {
        return super.getCell("AssessmentType");
    }

    public CsvCell getAssessmentReview() {
        return super.getCell("AssessmentReview");
    }

    public CsvCell getIDContact() {
        return super.getCell("IDContact");
    }
    ...
    public CsvCell getDateAssessmentTarget() {
        return super.getCell("DateAssessmentTarget");
    }

    public CsvCell getDateAssessmentCompleted() {
        return super.getCell("DateAssessmentCompleted");
    }

    public CsvCell getDateAssessmentReview() {
        return super.getCell("DateAssessmentReview");
    }

    public CsvCell getAssessmentScore() {
        return super.getCell("AssessmentScore");
    }

    public CsvCell getScoreOverrideReason() {
        return super.getCell("ScoreOverrideReason");
    }

    public CsvCell getAssessmentBudget() {
        return super.getCell("AssessmentBudget");
    }
    ...
    public CsvCell getReasonForReview() {
        return super.getCell("ReasonForReview");
    }

    public CsvCell getReasonForUnplannedReview() {
        return super.getCell("ReasonForUnplannedReview");
    }

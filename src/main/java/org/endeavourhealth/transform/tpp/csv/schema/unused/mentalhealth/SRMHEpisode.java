...
public class SRMHEpisode extends AbstractCsvParser {
    ...
    public CsvCell getMHEpisodeStartDate() {
        return super.getCell("MHEpisodeStartDate");
    }

    public CsvCell getMHEpisodeEndDate() {
        return super.getCell("MHEpisodeEndDate");
    }

    public CsvCell getMHEpisodeStaff() {
        return super.getCell("MHEpisodeStaff");
    }

    public CsvCell getCareCoOrdinator() {
        return super.getCell("CareCoOrdinator");
    }

    public CsvCell getNamedNurse() {
        return super.getCell("NamedNurse");
    }

    public CsvCell getLeadProfessional() {
        return super.getCell("LeadProfessional");
    }

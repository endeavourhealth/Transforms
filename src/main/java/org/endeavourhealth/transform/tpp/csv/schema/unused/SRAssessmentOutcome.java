...
public class SRAssessmentOutcome extends AbstractCsvParser {

 private static final Logger LOG = LoggerFactory.getLogger(SRAssessmentOutcome.class); 

  public SRAssessmentOutcome(UUID serviceId, UUID systemId, UUID exchangeId, String version, String filePath) throws Exception {
 ...
 public CsvCell getAssessmentOutcome() { return super.getCell("AssessmentOutcome");}
 ...
 //TODO fix the string below to make it meaningful
     @Override
protected String getFileTypeDescription() {return "TPP SRAssessmentOutcome Entry file ";}

...
public class SRPatientGroups extends AbstractCsvParser {
    ...
    public CsvCell getGroupType() {
        return super.getCell("GroupType");
    }

    public CsvCell getMembers() {
        return super.getCell("Members");
    }
    ...
    public CsvCell getIDStaffRemoved() {
        return super.getCell("IDStaffRemoved");
    }

    public CsvCell getIDProfileRemoved() {
        return super.getCell("IDProfileRemoved");
    }

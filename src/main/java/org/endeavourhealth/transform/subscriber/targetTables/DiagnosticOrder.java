...
public class DiagnosticOrder extends AbstractTargetTable {

    public DiagnosticOrder(CSVFormat csvFormat, String dateFormat, String timeFormat) throws Exception {

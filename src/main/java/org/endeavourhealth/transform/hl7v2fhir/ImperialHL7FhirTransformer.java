...
public abstract class ImperialHL7FhirTransformer {
    ...
    public static void transform(String exchangeBody, FhirResourceFiler fhirResourceFiler, String version) throws Exception {
        ...
        if("ADT_A01".equalsIgnoreCase(msgType)) {
            ...
            fhirLocation = transformPV1ToLocation(adtMsg.getPV1(), fhirLocation);
            fhirLocation.setManagingOrganization(ImperialHL7Helper.createReference(ResourceType.Organization, fhirOrganization.getId()));

            LocationBuilder locationBuilder = new LocationBuilder(fhirLocation);
            //Location

            //Organization
            fhirOrganization.addExtension().setValue(ImperialHL7Helper.createReference(ResourceType.Location, fhirLocation.getId()));
            ...
            fhirEncounter.addLocation().setLocation(ImperialHL7Helper.createReference(ResourceType.Location, fhirLocation.getId()));
    ...
    public static Patient transformPIDToPatient(PID pid, Patient patient) throws Exception {
        ...
        patient.addIdentifier().setValue(String.valueOf(id)).setSystem("http://imperial-uk.com/identifier/patient-id");
        patient.addIdentifier().setSystem("http://fhir.nhs.net/Id/nhs-number")
                .setValue(String.valueOf(nhsNumber));
    ...
    public static Practitioner transformPV1ToPractitioner(PV1 pv1, Practitioner practitioner) throws Exception {
        ...
        if(consultingDoctor != null && consultingDoctor.length > 0) {
            ...
            identifierCd.setSystem(String.valueOf(assigningAuthorityCd.getNamespaceID() ));
     ...
     * @throws Exception
     */
    public static Location transformPV1ToLocation(PV1 pv1, Location location) throws Exception {

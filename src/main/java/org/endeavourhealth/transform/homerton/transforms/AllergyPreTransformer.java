...
public class AllergyPreTransformer {
    private static final Logger LOG = LoggerFactory.getLogger(AllergyPreTransformer.class);
        ...
        try {
            for (ParserI parser: parsers) {
                while (parser.nextRecord()) {
                    ...
                    processRecord((AllergyTable)parser, fhirResourceFiler, csvHelper, threadPool);
                }
            }
    ...
    public static void processRecord(AllergyTable parser, FhirResourceFiler fhirResourceFiler, HomertonCsvHelper csvHelper, ThreadPool threadPool) throws Exception {

        CsvCell allergyIdCell = parser.getAllergyId();
        CsvCell encounterIdCell = parser.getEncounterId();

        PreTransformCallable callable = new PreTransformCallable(parser.getCurrentState(), allergyIdCell, encounterIdCell, csvHelper);
    ...
    static class PreTransformCallable extends AbstractCsvCallable {
        ...
        private CsvCell allergyIdCell;
        private CsvCell encounterIdCell;
        private HomertonCsvHelper csvHelper;

        public PreTransformCallable(CsvCurrentState parserState, CsvCell allergyIdCell, CsvCell encounterIdCell, HomertonCsvHelper csvHelper) {
            super(parserState);
            this.allergyIdCell = allergyIdCell;
        ...
        public Object call() throws Exception {
            ...
            try {
                ...
                csvHelper.cacheNewConsultationChildRelationship(encounterIdCell, allergyIdCell, ResourceType.AllergyIntolerance);

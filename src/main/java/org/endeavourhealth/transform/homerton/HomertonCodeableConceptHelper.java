...
public class HomertonCodeableConceptHelper {
    ...
    public static CodeableConceptBuilder applyCodeDescTxt(CsvCell codeCell, Long codeSet, HasCodeableConceptI resourceBuilder, String resourceBuilderTag, HomertonCsvHelper csvHelper) throws Exception {
        return applyCodeMeaningTxt(AUDIT_ELEMENT_CODE_DESC, codeCell, codeSet, resourceBuilder, resourceBuilderTag, csvHelper);
    }

    public static CodeableConceptBuilder applyCodeDisplayTxt(CsvCell codeCell, Long codeSet, HasCodeableConceptI resourceBuilder, String resourceBuilderTag, HomertonCsvHelper csvHelper) throws Exception {
        return applyCodeMeaningTxt(AUDIT_ELEMENT_CODE_DISPLAY, codeCell, codeSet, resourceBuilder, resourceBuilderTag, csvHelper);
    }

    public static CodeableConceptBuilder applyCodeMeaningTxt(CsvCell codeCell, Long codeSet, HasCodeableConceptI resourceBuilder, String resourceBuilderTag, HomertonCsvHelper csvHelper) throws Exception {
    ...
    private static CodeableConceptBuilder applyCodeMeaningTxt(String elementToApply, CsvCell codeCell,
                                                              ...
                                                              String resourceBuilderTag, HomertonCsvHelper csvHelper) throws Exception {

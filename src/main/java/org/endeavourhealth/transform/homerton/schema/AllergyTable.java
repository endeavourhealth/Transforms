...
public class AllergyTable extends AbstractCsvParser {
    ...
    protected String getFileTypeDescription() {
        return "Homerton allergies file";
    }
    ...
    public CsvCell getVocabulary() { return super.getCell("source_vocabulary"); }
    public CsvCell getAllergyCode() { return super.getCell("source_identifier"); }
    public CsvCell getAllergyDescriptionText() { return super.getCell("nomenclature_description"); }
    public CsvCell getAllergyDate() { return super.getCell("REACTION_STATUS_DT_TM"); }
    public CsvCell getReactionStatus() { return super.getCell("reaction_status"); }

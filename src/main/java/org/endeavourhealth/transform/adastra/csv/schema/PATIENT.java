...
public class PATIENT extends AbstractCsvParser {
    ...
    public CsvCell getNHSNoTraceStatus() {
        return super.getCell("NHSNoTraceStatus");
    }

    public CsvCell getLanguage() {
        return super.getCell("Language");
    }

    public CsvCell getEthnicity() {
        return super.getCell("Ethnicity");
    }
    ...
    public CsvCell getRegistrationType() {
        return super.getCell("RegistrationType");
    }

    public CsvCell getHomeAddressType() {
        return super.getCell("HomeAddressType");
    }

    public CsvCell getHomeAddressBuilding() {
        return super.getCell("HomeAddressBuilding");
    }

    public CsvCell getHomeAddressStreet() {
        return super.getCell("HomeAddressStreet");
    }

    public CsvCell getHomeAddressTown() {
        return super.getCell("HomeAddressTown");
    }

    public CsvCell getHomeAddressLocality() {
        return super.getCell("HomeAddressLocality");
    }

    public CsvCell getHomeAddressPostcode() {
        return super.getCell("HomeAddressPostcode");
    }

    public CsvCell getCurrentAddressType() {
        return super.getCell("CurrentAddressType");
    }

    public CsvCell getCurrentAddressBuilding() {
        return super.getCell("CurrentAddressBuilding");
    }

    public CsvCell getCurrentAddressStreet() {
        return super.getCell("CurrentAddressStreet");
    }

    public CsvCell getCurrentAddressTown() {
        return super.getCell("CurrentAddressTown");
    }

    public CsvCell getCurrentAddressLocality() {
        return super.getCell("CurrentAddressLocality");
    }

    public CsvCell getCurrentAddressPostcode() {
        return super.getCell("CurrentAddressPostcode");
    }

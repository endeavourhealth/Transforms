...
public class PROVIDER extends AbstractCsvParser {
    ...
    public CsvCell getGPNationalCode() { return super.getCell("GPNationalCode"); }
    public CsvCell getGPName() { return super.getCell("GPName"); }
    public CsvCell getGPPracticeNatCode() { return super.getCell("GPPracticeNatCode"); }
    public CsvCell getGPPracticeName() { return super.getCell("GPPracticeName"); }
    public CsvCell getGPPracticePostcode() { return super.getCell("GPPracticePostcode"); }

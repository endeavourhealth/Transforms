...
public class AdastraCaseDataExport {
    ...
    @XmlElement(namespace = "http://www.adastra.com/dataExport")
    protected List<Consultation> consultation;
    @XmlElement(namespace = "http://www.adastra.com/dataExport")
    protected List<SpecialNote> specialNote;
    @XmlElement(namespace = "http://www.adastra.com/dataExport")
     ...
     *
     */
    public List<SpecialNote> getSpecialNote() {
        if (specialNote == null) {
            specialNote = new ArrayList<SpecialNote>();
        }
